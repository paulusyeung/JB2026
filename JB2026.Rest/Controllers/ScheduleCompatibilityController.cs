...
public sealed class ScheduleCompatibilityController : ControllerBase
{
    ...
    private static string[] ExtractPrintInfo(string? productDetails, string? orderTitle)
    {
        ...
        var info1 = GetLabeledValue(plainText, ["印張尺寸", "尺寸", "size"]);
        var info2 = GetLabeledValue(plainText, ["顏色", "color"]);
        var info3 = GetLabeledValue(plainText, ["石數", "數量", "qty", "quantity", "名稱", "name"]);
