...
echo "Next steps:"
echo "  1. Edit $ETC_HOME/env and fill in the real secrets."
echo "  2. From the build machine run:  ./deploy.sh <user@host>"
echo "     (this deploys the app and starts the API)."
