...
public sealed class JobOrdersControllerTests
{
    ...
    public void GetAll_JobListMode_UsesJobListRepositoryPath()
    {
        ...
        var result = controller.GetAll(null, "acme", 2, "A", "job", null, null, null, null);
    ...
    public void GetAll_FilteredOrderList_UsesOrderListRepositoryPath()
    {
        ...
        var result = controller.GetAll(null, "acme", 0, null, null, null, null, null, null);
    ...
    public void GetAll_OrderListMode_UsesOrderListRepositoryPath()
    {
        ...
        var result = controller.GetAll(500, null, 0, null, "order", null, null, null, null);
