export const billingMessages = {
  ...
  clients: {
    ...
    messages: {
      ...
      loadRecordFailed: 'Unable to load the selected customer record.',
      migrateSuccess: 'Customer synced to Invoice Ninja successfully.',
      migrateFailed: 'Failed to sync customer to Invoice Ninja: {error}',
      alreadySynced: 'This customer is already synced to Invoice Ninja.',
    },
    form: {
      newTitle: 'New Client',
      ...
      requiredCode: 'Customer code',
      requiredBillTo: 'Bill To address',
      editCustomer: 'Edit Customer',
      editHint: 'This customer is missing required billing data. Edit the customer record to complete it.',
      migrate: 'Migrate',
      update: 'Update',
      cancel: 'Cancel',
