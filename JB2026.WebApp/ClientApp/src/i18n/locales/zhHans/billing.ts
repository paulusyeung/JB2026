export const billingMessages = {
  ...
  clients: {
    ...
    messages: {
      ...
      loadRecordFailed: '无法加载所选客户记录。',
      migrateSuccess: '客户已成功同步到 Invoice Ninja。',
      migrateFailed: '同步客户到 Invoice Ninja 失败：{error}',
      alreadySynced: '此客户已同步到 Invoice Ninja。',
    },
    form: {
      newTitle: '新建客户',
      editTitle: '客户记录',
      ...
      editCustomer: '编辑客户',
      editHint: '此客户缺少所需的账单数据。请编辑客户记录以补全。',
      migrate: '迁移',
      update: '更新',
      cancel: '取消',
      loadCustomersFailed: '无法加载客户列表。',
    },
  },
  invoices: {
    title: '账单发票',
