...
.quotations-page {
  min-height: 0;
  --quotations-header-bg: color-mix(in srgb, rgb(var(--v-theme-surface-variant)) 88%, rgb(var(--v-theme-primary)) 12%);
  --quotations-header-fg: rgb(var(--v-theme-on-surface-variant));
}
