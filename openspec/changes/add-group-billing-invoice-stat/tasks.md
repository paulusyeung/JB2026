...
- [x] 2.4 Configure the fixed default pivot layout with start/end date filters only, rows `CustomerName`, columns `Year` and `Month`, and summed `InvoiceAmount` values.
